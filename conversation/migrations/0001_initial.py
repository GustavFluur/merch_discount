...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('merchandises', '0003_alter_merchandise_category'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchandise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversations', to='merchandises.merchandise')),
            ],
            options={
